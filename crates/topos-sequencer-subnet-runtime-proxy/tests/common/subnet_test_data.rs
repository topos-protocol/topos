...
pub const TEST_VALIDATOR_SUBNET_DATA_DIR: &str = "/test_data";
pub const TEST_VALIDATOR_KEY_FILE_NAME: &str = "/consensus/validator.key";

pub const TEST_VALIDATOR_KEY_FILE_DATA: &str =
    r#"11eddfae7abe45531b3f18342c8062969323a7131d3043f1a33c40df74803cc7"#;

pub fn generate_test_validator_dir() -> Result<std::path::PathBuf, Box<dyn std::error::Error>> {
