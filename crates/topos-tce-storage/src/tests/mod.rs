...
async fn can_persist_a_delivered_certificate(store: Arc<ValidatorStore>) {
    ...
    let certificate = CertificateDelivered {
        ...
        proof_of_delivery: ProofOfDelivery {
            delivery_position: SourceStreamPositionKey(SOURCE_SUBNET_ID_1, Position(0)),
            readies: vec![],
            threshold: 0,
            certificate_id,
        },
...
async fn fetch_certificates_for_subnets(store: Arc<ValidatorStore>) {
    ...
    let other_certificate = CertificateDelivered {
        ...
        proof_of_delivery: ProofOfDelivery {
            certificate_id,
            delivery_position: SourceStreamPositionKey(TARGET_SUBNET_ID_2, Position(0)),
            readies: vec![],
            threshold: 0,
        },
    };
    ...
    let certificate_ids_second = store
        .get_source_stream_certificates_from_position(
            SourceStreamPositionKey(SOURCE_STORAGE_SUBNET_ID, Position(5)),
            5,
        )
        .unwrap()
        .into_iter()
...
async fn get_source_head_for_subnet(store: Arc<ValidatorStore>) {
    ...
    let new_certificate_source_subnet_1 = CertificateDelivered {
        ...
        proof_of_delivery: ProofOfDelivery {
            ...
            delivery_position: SourceStreamPositionKey(SOURCE_SUBNET_ID_1, Position(10)),
            readies: vec![],
            threshold: 0,
        },
    };
    ...
    let other_certificate_2 = CertificateDelivered {
        ...
        proof_of_delivery: ProofOfDelivery {
            ...
            delivery_position: SourceStreamPositionKey(SOURCE_SUBNET_ID_1, Position(11)),
            readies: vec![],
            threshold: 0,
        },
    };
