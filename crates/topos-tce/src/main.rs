...
async fn main() {
    ...
    let tracer = opentelemetry_otlp::new_pipeline()
        ...
        .with_exporter(
            opentelemetry_otlp::new_exporter()
                .tonic()
                .with_endpoint("http://otel-collector-opentelemetry-collector.observability:4317"),
        )
        .with_trace_config(
            trace::config()
    ...
    let export_config = ExportConfig {
        endpoint: "http://otel-collector-opentelemetry-collector.observability:4317".to_string(),
