...
case "$1" in
    ...
    "boot")
        ...
        export TCE_LOCAL_VPK=122f3ae6ade1fd136b292cea4f6243c7811160352c8821528547a1fe7c459daf # randomly generated private key
        export TCE_VALIDATORS=0xfa1dbe573e7ab7eb4fb772a349129cf0833f1154 # generated public ethereum address from private key above
        export TCE_EXT_HOST
   ...
   "peer")
       if [[ ${LOCAL_TEST_NET:-"false"} == "true" ]]; then
           ...
           export TCE_LOCAL_KS=$HOSTNAME
           export TCE_LOCAL_VPK=a2e33a9bad88f7b7568228f51d5274c471a9217162d46f1533b6a290f0be1baf # randomly generated private key
           export TCE_VALIDATORS=0xfa1dbe573e7ab7eb4fb772a349129cf0833f1154 # generated public ethereum address from private key above
           export TCE_EXT_HOST
